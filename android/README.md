...
搭子联机只对正式激活设备开放；体验期开放高级互动、词包、小剧场、提醒和外部图鉴目录，体验结束后基础桌宠、拖动、走动和最多 3 个自定义 GIF 继续免费。Android 设备独立计为一个激活设备，暂不与 PC/macOS 同步本地数据。绑定目录走系统「打开文件夹」授权，卸载应用后权限会失效，需要重新选择。
