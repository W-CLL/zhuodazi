...
final class PetWindowController {
    ...
    private static let defaultWords: [String: [String]] = [
        "happy": ["笑这么大声，是会议取消了吗？", "这波可以，建议立刻截图留念。", "好事发生了？那我允许你再摸五分钟。"],
        "shy": ["突然看我？我、我只是路过这个像素。", "别盯太久，我会假装很忙。"],
        "surprised": ["啊？这个展开我没备案。", "等等，剧本是不是拿错了。"],
        "confused": ["每个字都认识，合在一起就请假了。", "看不懂很正常，它写得也心虚。"],
        "cheer": ["先做完眼前这件，别的以后再编。", "你继续，我把加油说得不那么像鸡汤。"],
        "grab": ["轻点，我的像素会掉渣。", "这是搬家还是绑架？先说清楚。"],
        "switch": ["换班了，上一位把零食吃完就跑。", "新选手登场，请把鼠标让一让。"],
        "chase": ["鼠标别跑，我还没热身完。", "等等我，像素腿没有那么长。"],
        "dodge": ["差点！你下手太突然了。", "闪了。不是怕你，是保持神秘。"],
        "bounce": ["碰到边啦，这不叫撞，叫折返。", "边到了，我弹回来找你算账。"],
        "theater_finish": ["谢幕。把掌声留给下一次摸鱼。", "演完了，心情还没下班。"]
    ]
