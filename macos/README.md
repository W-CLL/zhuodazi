...
这是使用 Swift 与 AppKit 实现的原生 macOS 3.2.6 版，最低支持 macOS 13。
...
- 首次使用可完整体验 7 天；体验期内可使用摸鱼广告，并可点菜单模仿女友、好友、搭子来访。之后保留 3 个自定义桌宠、1 个内置资源库和基础陪伴，激活后可继续使用摸鱼广告，并解锁互动、小剧场、提醒、内容导入和发给搭子
