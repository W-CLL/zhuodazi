...
这是使用 Swift 与 AppKit 实现的原生 macOS 3.1.7 版，最低支持 macOS 13。
...
- 首次使用可完整体验 1 天；体验期内系统会本地演示一次来访（不是真配对）。之后保留 3 个自定义桌宠、1 个内置资源库和基础陪伴，激活后解锁互动、小剧场、提醒、内容导入和发给搭子
...
- `ZhuoDazi-macOS-3.1.7-arm64.zip`
- `ZhuoDazi-macOS-3.1.7-x86_64.zip`
